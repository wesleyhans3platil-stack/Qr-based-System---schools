...
$allowedRoles = ['asst_superintendent', 'superintendent', 'super_admin'];
    ...
    $(function() {
        ...
        function updateSchoolCards(schools) {
            ...
            schools.forEach(s => {
                ...
                card.href = `asds_dashboard.php?school=${s.id}&date=${encodeURIComponent(new URLSearchParams(window.location.search).get('date') || '')}`;
        ...
        function poll() {
            ...
            let url = API_URL + '?role=asst_superintendent';
